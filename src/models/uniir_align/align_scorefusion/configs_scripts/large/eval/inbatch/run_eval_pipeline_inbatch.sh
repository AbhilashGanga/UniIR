...
SRC="/home/ag4797/ADL/UniIR/src"  # Absolute path to codebse /UniIR/src # <--- Change this to the path of your UniIR/src

# Path to common dir
COMMON_DIR="$SRC/common"

# Path to MBEIR data and UniIR directory where we store the checkpoints, embeddings, etc.
UNIIR_DIR="/home/ag4797/ADL/UniIR/" # <--- Change this to the UniIR directory
MBEIR_DATA_DIR="/home/ag4797/ADL/M-BEIR/" # <--- Change this to the MBEIR data directory you download from HF page

# Path to config dir
MODEL="uniir_align/align_scorefusion"  # <--- Change this to the model you want to run
